<script>
	import BlogOverview from "../../components/BasicUI/Blog/BlogOverview.svelte";
</script>

<svelte:head>
    <meta name="description" content="Tips en tricks rond opvoeding van kinderen. Meer informatie rond de diensten van Praktijk Mobiel of rond de nieuwigheden!">
    <meta name="author" content="Praktijk Mobiel">
    <meta property="og:locale" content="nl_NL">
    <link rel="canonical" href="https://www.praktijkmobiel.be/Blog">

    <title>Kinderen opvoeden | Praktijk Mobiel</title>
</svelte:head>


<section class="bg-blog-image-sm md:bg-blog-image-md lg:bg-blog-image-lg bg-clip-content pb-0 bg-cover bg-fixed min-h-screen">

	<div class="py-40">
        <div class="m-0 md:mx-36 lg:mx-56 py-12 rounded-lg bg-white bg-opacity-80 min-h-screen">
			<h1 class="text-yellow text-4xl font-bold text-center mb-12 mt-6">Wat is er nieuw in de wereld van de kinderpsychologie</h1>
